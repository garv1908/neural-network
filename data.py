...
def get_mnist():
    ...
    # reshape the 'images' array to a [ 60000 x 784 ] matrix
        # images is originally imported as a [ 60000 x 28 x 28 ] 3D matrix
        # images.shape[0]: number of images (i.e. 60000)
    ...
    # One-hot encoding the 'labels' data
        ...
        # shape: (60000, 10) -> 60000 images to be labelled, 10 due to 'labels' being one-hot encoded
